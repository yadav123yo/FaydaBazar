...
export const getAllProducts = (query) => async (dispatch) => {
  ...
  try {
    ...
    const res = await axios.get(`https://faydab.onrender.com/product?${q}`);
...
export const getSingleProduct = (id) => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://faydab.onrender.com/product/${id}`
    );
...
export const addProduct = (data) => async (dispatch) => {
  ...
  try {
    ...
    const res = await fetch("https://faydab.onrender.com/product", {
...
export const updateProduct = (id, data) => async (dispatch) => {
  ...
  try {
    ...
    await fetch(`https://faydab.onrender.com/product/${id}`, {
      body: JSON.stringify(data),
      method: "PUT",
      headers: {
        token: localStorage.getItem("token"),
